...
docker run --rm -t \
  ...
  -e SKYKOI_LIVE_MODELS="${SKYKOI_LIVE_MODELS:-${SKYKOI_LIVE_MODELS:-all}}" \
  -e SKYKOI_LIVE_PROVIDERS="${SKYKOI_LIVE_PROVIDERS:-${SKYKOI_LIVE_PROVIDERS:-}}" \
  -e SKYKOI_LIVE_MODEL_TIMEOUT_MS="${SKYKOI_LIVE_MODEL_TIMEOUT_MS:-${SKYKOI_LIVE_MODEL_TIMEOUT_MS:-}}" \
  -e SKYKOI_LIVE_REQUIRE_PROFILE_KEYS="${SKYKOI_LIVE_REQUIRE_PROFILE_KEYS:-${SKYKOI_LIVE_REQUIRE_PROFILE_KEYS:-}}" \
