...
export function listSignalAccountIds(cfg: SKYKOIConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: SKYKOIConfig): string {
...
function mergeSignalAccountConfig(cfg: SKYKOIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SKYKOIConfig): ResolvedSignalAccount[] {
