...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "SkyKoi-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveSkyKoiPackageRoot } = await import("./SkyKoi-root.js");
    ...
    vi.mocked(resolveSkyKoiPackageRoot).mockResolvedValue("/opt/SkyKoi");
