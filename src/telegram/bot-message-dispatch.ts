...
import type { SKYKOIConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: SKYKOIConfig, agentId: string) {
  try {
