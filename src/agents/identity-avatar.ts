...
function resolveAvatarSource(cfg: SkyKoiConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SkyKoiConfig, agentId: string): AgentAvatarResolution {
