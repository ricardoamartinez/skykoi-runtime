...
// pi-ai's built-in Anthropic catalog can lag behind SkyKoi's defaults/docs.
...
export function buildModelAliasLines(cfg?: SkyKoiConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveSkyKoiAgentDir();
