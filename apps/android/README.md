## SKYKOI Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_SKYKOI-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm SKYKOI gateway --port 18789 --verbose
```
