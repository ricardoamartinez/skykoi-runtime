...
SKYKOI has two separate “streaming” layers:
...
When block streaming is enabled, SKYKOI can **merge consecutive block chunks**
...
When draft streaming is active, SKYKOI disables block streaming for that reply to avoid double-streaming.
