---
summary: "First-run onboarding flow for SkyKoi (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give SkyKoi">
...
<Step title="CLI">
  ...
  The app can install the global `SkyKoi` CLI via npm/pnpm so terminal
