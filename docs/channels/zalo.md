...
- Install via CLI: `SkyKoi plugins install @SkyKoi/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `SkyKoi plugins install ./extensions/zalo`
   - From npm (if published): `SkyKoi plugins install @SkyKoi/zalo`
...
- Approve via:
  - `SkyKoi pairing list zalo`
  - `SkyKoi pairing approve zalo <CODE>`
...
- Example: `SkyKoi message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `SkyKoi channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `SkyKoi logs --follow`
