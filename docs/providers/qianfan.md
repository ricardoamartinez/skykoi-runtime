---
summary: "Use Qianfan's unified API to access many models in SKYKOI"
read_when:
...
3. SKYKOI installed on your system
...
4. Copy the API key for use with SKYKOI

## CLI setup

```bash
SKYKOI onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [SKYKOI Configuration](/gateway/configuration)
