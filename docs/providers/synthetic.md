---
summary: "Use Synthetic's Anthropic-compatible API in SkyKoi"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. SkyKoi registers it as the
...
Note: SkyKoi's Anthropic client appends `/v1` to the base URL, so use
