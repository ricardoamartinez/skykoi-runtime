...
- Same path: run the app from a fixed location (for SKYKOI, `dist/SKYKOI.app`).
...
Workaround: move files into the SKYKOI workspace (`~/.SKYKOI/workspace`) if you want to avoid per-folder grants.
