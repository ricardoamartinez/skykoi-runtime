...
This directory contains the **BlueBubbles external channel plugin** for SKYKOI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `SKYKOI/plugin-sdk` helpers.
