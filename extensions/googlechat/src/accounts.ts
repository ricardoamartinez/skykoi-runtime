...
export function listGoogleChatAccountIds(cfg: SkyKoiConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: SkyKoiConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: SkyKoiConfig): ResolvedGoogleChatAccount[] {
