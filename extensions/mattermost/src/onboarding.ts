import type { ChannelOnboardingAdapter, SkyKoiConfig, WizardPrompter } from "SkyKoi/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.skykoi.ai/channels/mattermost",
    ].join("\n"),
