...
export function listMattermostAccountIds(cfg: SkyKoiConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: SkyKoiConfig): string {
...
export function listEnabledMattermostAccounts(cfg: SkyKoiConfig): ResolvedMattermostAccount[] {
